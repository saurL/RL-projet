...
class CustomEnv(PyBoyGymEnv):
  ...
  def step(self, action):
      ...
      currScore = (currState.score + currState.time_left * 10) + currState._level_progress_max * 10
      prevScore = (self.prevState.score + self.prevState.time_left * 10) + self.prevState._level_progress_max * 10
